...
#
# python people_counter_openvino.py --target cpu --mode vertical --conf config/config.json --input videos/example_01.mp4 --output output/output_01.avi
...
API = "https://api.thingspeak.com/update?api_key=Q9XWVL8H7GZ6ZD29&field1="
...
def sending_on_thingspeak():
    ...
    while True:
        ...
        if count == -1:
            ...
            data=urllib.request.urlopen(API+str(count))
            count = 0
